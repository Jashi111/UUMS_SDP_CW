                ...
                <div class="card-body">
                  <div class="row">
                    <div class="form-group col-md-8">
                      ...
                      <input type="text" class="form-control" name="role" id="role" value="{{ $fetchedRecord->role }}" placeholder="Enter Role" readonly>
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="image">
                            <img src="{{ '\uploads\profile_img\\' . $fetchedRecord->prof_pic }}" class="img-fluid d-block mx-auto" style="width:40%; height:10%; align-content:center" alt="User Image">
                              <div class="row mt-1">
