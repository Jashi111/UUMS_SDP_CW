...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><i class="nav-icon fas fa-user-shield"></i> Lecturer List</h1>
          </div>
          <div class="col-sm-6">
            @include('message')
          </div>
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <a href="{{ url('managementStaff/lecturer/list') }}" class="btn btn-warning" style="margin-top: 32px">Reset</a>
                    </div>
                  </div>
                </div>
              </form>
              ...
              <div class="card-header">
                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 150px;">
                    <div class="row">
                      <a href="{{ url('managementStaff/lecturers/add') }}" class="btn btn-primary float-end"><i class="fas fa-plus"></i> Add New Lecturer</a>
                    </div>
                  </div>
                </div>
              </div>
