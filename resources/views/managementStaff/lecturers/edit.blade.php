                ...
                <div class="card-body">
                  <div class="row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" name="role" id="role" value="{{ old('role', $fetchedRecord->role) }}" readonly>
                      </select>
                    </div>
                    <div class="form-group col-md-6">
                  ...
                  <div class="row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" name="first_name" id="first_name" value="{{ old('first_name', $fetchedRecord->first_name) }}" placeholder="Enter First Name">
                      <div style="color: rgb(196, 3, 3)">{{ $errors->first('first_name') }}</div>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="last_name">Last Name <span style="color: red">*</span></label>
                      <input type="text" class="form-control" name="last_name" id="last_name" value="{{ old('last_name', $fetchedRecord->last_name) }}" placeholder="Enter Last Name">
                  ...
                  <div class="form-group col-md-6">
                    <label for="email">E-Mail <span style="color: red">*</span></label>
                      <input type="email" class="form-control" name="email" id="email" value="{{ old('email', $fetchedRecord->email) }}" placeholder="Enter Email">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" name="nic" id="nic" value="{{ old('nic', $fetchedRecord->nic) }}" placeholder="Enter NIC Number">
                  ...
                  <div class="row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" name="mobile_number" id="mobile_number" value="{{ old('mobile_number', $fetchedRecord->mobile_number) }}" placeholder="Enter Mobile Number">
                      ...
                      <input type="date" class="form-control" name="joined_date" id="joined_date" value="{{ old('joined_date', $fetchedRecord->joined_date) }}">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <textarea class="form-control" name="address" id="address" rows="4" value="{{ old('address', $fetchedRecord->address) }}" placeholder="Enter Address"></textarea>
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-md-6">
                      ...
                      <p style="color: darkgrey">Add a password only if you wish to reset the password</p>
                    </div>
                    <div class="form-group col-md-6">
